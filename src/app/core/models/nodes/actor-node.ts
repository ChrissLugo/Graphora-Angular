			...
			new go.Panel('Vertical', {
				...
				new go.Panel('Auto', {}).add(
					new go.Panel('Spot', {
						...
						// Cuerpo
						new go.Shape({
							geometry: go.Geometry.parse('F M0 32 L0 60'),
							stroke: '#fff',
							strokeWidth: 5,
							alignment: go.Spot.Top,
							alignmentFocus: go.Spot.Top,
						...
						// Brazos
						new go.Shape({
							geometry: go.Geometry.parse('F M0 40 L35 40'),
							stroke: '#fff',
							strokeWidth: 5,
							alignment: go.Spot.Top,
							alignmentFocus: go.Spot.Top,
						...
						// // Pierna derecha
						new go.Shape({
							geometry: go.Geometry.parse('F M10 59 L20 100'),
							stroke: '#fff',
							strokeWidth: 5,
							alignment: go.Spot.Top,
							alignmentFocus: go.Spot.Top,
						...
						// Pierna izquierda
						new go.Shape({
							geometry: go.Geometry.parse('F M5 59 L-5 100'),
							stroke: '#fff',
							strokeWidth: 5,
							alignment: go.Spot.Top,
							alignmentFocus: go.Spot.Top,
