...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'favorites',
        loadComponent: () => import('./business/favorites/favorites.component'),
        // canActivate: [authGuard],
      },
      {
        path: 'shared',
        loadComponent: () => import('./business/shared/shared.component'),
        // canActivate: [authGuard],
      },
      {
        path: 'notifications',
  ...
  {
    path: 'new',
    loadComponent: () => import('./business/new/new.component'),
    // canActivate: [authGuard],
  },
  {
    path: 'login',
